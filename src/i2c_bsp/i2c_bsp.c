...
void i2c_master_Init(void)
{
  ...
  i2c_master_bus_config_t i2c_bus_config = 
  {
    ...
    .i2c_port = I2C_NUM_0,
    .scl_io_num = MFS_PIN_I2C0_SCL,
    .sda_io_num = MFS_PIN_I2C0_SDA,
    .glitch_ignore_cnt = 7,
    .flags = {
  ...
  i2c_bus_config.scl_io_num = MFS_PIN_I2C1_TOUCH_SCL;
  i2c_bus_config.sda_io_num = MFS_PIN_I2C1_TOUCH_SDA;
